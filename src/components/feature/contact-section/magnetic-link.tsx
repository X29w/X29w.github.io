...
/**
 * @description [zh-CN] 根据图标名称�?Lucide 图标库中获取对应图标组件
 * @description [en] Retrieves the corresponding icon component from the Lucide icon library by icon name
 * @description [ja] アイコン名に基づいて Lucide アイコンライブラリから対応するアイコンコンポーネントを取得す�?
 * @description [zh-TW] 根據圖示名稱�?Lucide 圖示庫中取得對應圖示元件
 */
...
/**
 * @description [zh-CN] 磁性链接按钮组件的属性接�?
 * @description [en] MagneticLink component props interface
 * @description [ja] MagneticLink コンポーネントのプロパティインターフェー�?
 * @description [zh-TW] 磁性連結按鈕元件的屬性介�?
 */
...
/**
 * @description [zh-CN] 磁性链接按钮组件，光标靠近时产生吸附效�?
 * @description [en] Magnetic link button component that follows cursor slightly when nearby
 * @description [ja] カーソルが近づくとわずかに追従するマグネティックリンクボタンコンポーネン�?
