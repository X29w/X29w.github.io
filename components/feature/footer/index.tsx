...
/**
 * @description [zh-CN] 社交链接图标映射表
 * @description [en] Social link icon mapping
 * @description [ja] ソーシャルリンクアイコンマッピング
 * @description [zh-TW] 社交連結圖示映射表
 */
...
/**
 * @description [zh-CN] 页脚组件，包含社交链接、技术栈徽章和返回顶部按钮
 * @description [en] Footer component with social links, tech stack badges, and back-to-top button
 * @description [ja] ソーシャルリンク、技術スタックバッジ、トップに戻るボタンを含むフッターコンポーネント
 * @description [zh-TW] 頁尾元件，包含社交連結、技術棧徽章和返回頂部按鈕
 */
const Footer: FC = () => {
  /**
   * @description [zh-CN] 平滑滚动到页面顶部
   * @description [en] Smoothly scrolls to the top of the page
   * @description [ja] ページの先頭にスムーズにスクロールする
   * @description [zh-TW] 平滑捲動到頁面頂部
   */
